...
class __NEL__a33433bdfdf808e24705d4d2613148af extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section0e2eadb24758795668bb018f4b6fa064($context, $indent, $value);
        $buffer .= $indent . '
';
        // 'taxonomies' section
...
';
    ...
    private function section66cba78a9c43f6e14e7581453b211279(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
              <a href="{{wpml.docs.post_translation.url}}">{{wpml.docs.post_translation.title}}</a>
            ';
...
';
    ...
    private function section0e2eadb24758795668bb018f4b6fa064(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section66cba78a9c43f6e14e7581453b211279($context, $indent, $value);
                $buffer .= $indent . '          </div>
';
